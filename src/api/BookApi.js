...
const apiEndpoints = {
  getDatas:      { method: get,     path: '/Books/?page[limit]=50' },
  createData:    { method: post,    path: '/Books' },
  updateData:    { method: patch,   path: '/Books/:id' },
  destroyData:   { method: destroy, path: '/Books/:id' },
};
        ...
        return new Promise((resolve, reject) => {
            setTimeout(() => {
                ...
                if (data.id) {
                    ...
                    api.updateData({id:data.id},{data:{id:data.id,type:'Book',attributes:attributes}});
                } else {
                    ...
                    api.createData({data:{type:'Book',attributes:attributes}})
                        .then((result)=>{
